...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Lock And Load Stack"] = {
			...
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 7,
			["width"] = 9.04940795898438,
			["xOffset"] = -284,
			["font"] = "Calibri Bold",
			["numTriggers"] = 1,
			["id"] = "Lock And Load Stack",
			["height"] = 20.1095924377441,
			["conditions"] = {
			},
			["load"] = {
				["use_never"] = false,
