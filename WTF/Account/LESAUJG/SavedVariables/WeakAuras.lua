...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Throwing Axes Stacks"] = {
			...
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 7,
			["width"] = 11.8814516067505,
			["anchorPoint"] = "CENTER",
			["font"] = "Friz Quadrata TT",
			["numTriggers"] = 1,
			["wordWrap"] = "WordWrap",
			["height"] = 15.7628746032715,
			["fixedWidth"] = 200,
			["load"] = {
				["talent2"] = {
					["multi"] = {
