...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Focus Text"] = {
			...
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 1,
			["width"] = 8.47508907318115,
			["progressPrecision"] = 0,
			["font"] = "Calibri Bold",
			["numTriggers"] = 1,
			["anchorPoint"] = "CENTER",
			["height"] = 17.8916645050049,
			["conditions"] = {
			},
			["load"] = {
				["talent2"] = {
