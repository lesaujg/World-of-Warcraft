...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Marked Shot Tracker"] = {
			...
			["frameStrata"] = 7,
			["width"] = 9.00806140899658,
			["selfPoint"] = "BOTTOMLEFT",
			["font"] = "Bazooka",
			["numTriggers"] = 1,
			["id"] = "Marked Shot Tracker",
			["height"] = 20.0176315307617,
			["expanded"] = true,
			["load"] = {
				["use_petbattle"] = false,
				["use_never"] = false,
