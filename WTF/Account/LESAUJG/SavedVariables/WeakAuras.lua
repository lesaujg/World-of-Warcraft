...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Throwing Axes Stacks"] = {
			...
			["frameStrata"] = 7,
			["width"] = 8.01458835601807,
			["anchorPoint"] = "CENTER",
			["font"] = "Friz Quadrata TT",
			["numTriggers"] = 1,
			["anchorFrameType"] = "SCREEN",
			["height"] = 16.0291118621826,
			["conditions"] = {
			},
			["load"] = {
				["talent"] = {
