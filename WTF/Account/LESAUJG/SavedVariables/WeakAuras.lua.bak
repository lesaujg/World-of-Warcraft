...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Lock And Load Stack"] = {
			...
			["anchorFrameType"] = "SCREEN",
			["frameStrata"] = 7,
			["width"] = 12.8897943496704,
			["additional_triggers"] = {
			},
			["font"] = "Calibri Bold",
			["numTriggers"] = 1,
			["parent"] = "Hunter Rotation",
			["height"] = 19.7553272247314,
			["conditions"] = {
			},
			["load"] = {
				["ingroup"] = {
