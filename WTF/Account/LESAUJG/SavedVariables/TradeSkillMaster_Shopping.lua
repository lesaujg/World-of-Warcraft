...
TradeSkillMaster_ShoppingDB = {
	...
	["global"] = {
		...
		["previousSearches"] = {
			...
			"Sorcerous Air/exact", -- [4]
			"luminous shard/exact", -- [5]
			"temporal crystal/exact", -- [6]
			"Essence of Air/exact/x5", -- [7]
			"Talador Orchid/exact/x88", -- [8]
			"Righteous Orb/exact/x2", -- [9]
			"Mysterious Essence/exact/x2", -- [10]
			"Large Brilliant Shard/exact/x4", -- [11]
			"Icecap/exact/x1", -- [12]
			"Frostweed/exact/x72", -- [13]
			"Draenic Stamina Flask/exact/x10", -- [14]
			"draenic dust/exact", -- [15]
			"flask", -- [16]
