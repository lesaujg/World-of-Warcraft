...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Bracnar - Sisters of Elune"] = {
			["lastbossyell"] = "Zereketh the Unbound: Timewalker",
			["IL"] = 724.066650390625,
			["LastSeen"] = 1449750157,
			["Class"] = "HUNTER",
			["currency"] = {
			...
			["LClass"] = "Hunter",
			["RBGrating"] = 0,
			["PlayedTotal"] = 29928164,
			["lastbossyelltime"] = 1449719504,
			["Money"] = 1422172731,
			["lastbosstime"] = 1449719504,
			["lastboss"] = "Zereketh the Unbound: Timewalker",
			["Skills"] = {
			},
			["Show"] = "saved",
			["BonusRoll"] = {
