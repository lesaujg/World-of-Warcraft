...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Bracnar - Sisters of Elune"] = {
			["lastbossyell"] = "Emberhusk Dominator: Heroic",
			["IL"] = 853.8125,
			["LastSeen"] = 1476673971,
			["Order"] = 50,
			["Class"] = "HUNTER",
			...
			["RBGrating"] = 0,
			["WeeklyResetTime"] = 1476802799,
			["PlayedTotal"] = 31136854,
			["lastbosstime"] = 1476671469,
			["lastbossyelltime"] = 1476671560,
			["Money"] = 1703523575,
			["DailyResetTime"] = 1476716399,
			["lastboss"] = "Dargrul the Underking: Heroic",
			["BonusRoll"] = {
				{
					["money"] = 368493,
