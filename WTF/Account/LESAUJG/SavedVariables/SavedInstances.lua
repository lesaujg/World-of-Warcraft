...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Bracnar - Sisters of Elune"] = {
			...
			["Show"] = "saved",
			["PlayedTotal"] = 31928073,
			["Level"] = 110,
			["LClass"] = "Hunter",
			["RBGrating"] = 0,
			["Zone"] = "Trueshot Lodge",
			["lastbosstime"] = 1486785206,
			["WeeklyResetTime"] = 1487084399,
			["lastbossyelltime"] = 1486785211,
			["Money"] = 11995815425,
			["DailyResetTime"] = 1486825199,
			["lastboss"] = "Trilliax: Looking For Raid",
			["BonusRoll"] = {
				{
					["time"] = 1486522707,
