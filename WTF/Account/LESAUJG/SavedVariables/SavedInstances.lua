...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Bracnar - Sisters of Elune"] = {
			["lastbossyell"] = "Vision of Deathwing",
			["IL"] = 817.9375,
			["LastSeen"] = 1473820342,
			["Order"] = 50,
			["Class"] = "HUNTER",
			...
			["lastbosstime"] = 1473814443,
			["Level"] = 110,
			["LClass"] = "Hunter",
			["RBGrating"] = 0,
			["WeeklyResetTime"] = 1474383599,
			["PlayedTotal"] = 30676824,
			["Zone"] = "Path of Huln",
			["lastbossyelltime"] = 1473820280,
			["Money"] = 3234844470,
			["Skills"] = {
			},
			["Show"] = "saved",
