...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Galinar - Sisters of Elune"] = {
			["lastbossyell"] = "Cordana Felsong: Normal",
			["IL"] = 845.8125,
			["LastSeen"] = 1492829423,
			["Order"] = 50,
			["Class"] = "PALADIN",
			...
			["lastbosstime"] = 1492829240,
			["Race"] = "Dwarf",
			["lastbossyelltime"] = 1492829240,
			["Money"] = 5772230,
			["Skills"] = {
			},
			["PlayedTotal"] = 303236,
			["lastboss"] = "Cordana Felsong: Normal",
			["Show"] = "saved",
			["BonusRoll"] = {
				{
					["name"] = "Shar'thos",
