...
SavedInstancesDB = {
	...
	["Toons"] = {
		...
		["Allala - Sisters of Elune"] = {
			["lastbossyell"] = "Eredar Deathspeaker: Normal Scenario",
			["IL"] = 873.375,
			["Zone"] = "Dalaran",
			["Order"] = 50,
			["Class"] = "PALADIN",
			...
			["lastbosstime"] = 1517719148,
			["PlayedTotal"] = 8480,
			["lastbossyelltime"] = 1517720646,
			["Money"] = 10546470,
			["LastSeen"] = 1517721114,
			["lastboss"] = "Horridon: 10 Player (Heroic)",
			["BonusRoll"] = {
