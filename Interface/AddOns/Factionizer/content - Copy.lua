...
-- ToBeDone.Outland daily dungeon quest (heroic)
	...
	---- spillover from 1068.5	
		FIZ_AddQuest(978, 4, 8, 11391, 62.5)
	---- spillover from 1126.5	
		FIZ_AddQuest(978, 4, 8, 12869, 62.5)
	---- spillover from 1094.5	
		FIZ_AddQuest(978, 4, 8, 13757, 62.5, {[44981] = 1})
		FIZ_AddQuest(978, 4, 8, 13759, 62.5)
		FIZ_AddQuest(978, 4, 8, 13769, 62.5)
		FIZ_AddQuest(978, 4, 8, 13857, 62.5)
		FIZ_AddQuest(978, 4, 8, 13671, 62.5)
		FIZ_AddQuest(978, 4, 8, 13625, 62.5)
		FIZ_AddQuest(978, 4, 8, 13772, 62.5)
		FIZ_AddQuest(978, 4, 8, 13772, 62.5)
	---- spillover from 1050.5	
		FIZ_AddQuest(978, 4, 8, 11153, 62.5)
		FIZ_AddQuest(978, 4, 8, 13309, 62.5)
		FIZ_AddQuest(978, 4, 8, 13284, 62.5)
		FIZ_AddQuest(978, 4, 8, 13336, 62.5)
		FIZ_AddQuest(978, 4, 8, 13280, 62.5)
		FIZ_AddQuest(978, 4, 8, 12444, 62.5)
		FIZ_AddQuest(978, 4, 8, 12296, 62.5)
		FIZ_AddQuest(978, 4, 8, 12289, 62.5)
		FIZ_AddQuest(978, 4, 8, 12268, 62.5)
		FIZ_AddQuest(978, 4, 8, 12244, 62.5)
	---- spillover from tournament	
		FIZ_AddQuest(978, 4, 8, 13809, 125)
		FIZ_AddQuest(978, 4, 8, 13810, 125)
		FIZ_AddQuest(978, 4, 8, 13862, 125)
		FIZ_AddQuest(978, 4, 8, 13811, 125)
	---- spillover from dungeon	
		FIZ_AddInstance(978, 4, 8, instance.spill_rep_dun, 400, false)
		FIZ_AddInstance(978, 4, 8, instance.spill_rep_dun, 800, true)
	---- spillover from 1068	
		FIZ_AddQuest(978, 4, 8, 11391, 125)
	---- spillover from 1126.5	
		FIZ_AddQuest(978, 4, 8, 12869, 62.5)
	---- spillover from 1094.5	
		FIZ_AddQuest(978, 4, 8, 13757, 62.5, {[44981] = 1})
	...
	---- spillover from dungeon	
		...
		FIZ_AddInstance(978, 4, 8, instance.spill_rep_dun, 800, true)
	---- spillover from 1126	
		FIZ_AddQuest(978, 4, 8, 12869, 125)
	---- spillover from 1068.5	
		FIZ_AddQuest(978, 4, 8, 11391, 62.5)
	---- spillover from 1094.5	
		FIZ_AddQuest(978, 4, 8, 13757, 62.5, {[44981] = 1})
	...
	---- spillover from dungeon	
		...
		FIZ_AddInstance(978, 4, 8, instance.spill_rep_dun, 800, true)
	---- spillover from 1094	
		FIZ_AddQuest(978, 4, 8, 13757, 125, {[44981] = 1})
		FIZ_AddQuest(978, 4, 8, 13759, 125)
		FIZ_AddQuest(978, 4, 8, 13769, 125)
		FIZ_AddQuest(978, 4, 8, 13857, 125)
		FIZ_AddQuest(978, 4, 8, 13671, 125)
		FIZ_AddQuest(978, 4, 8, 13625, 125)
		FIZ_AddQuest(978, 4, 8, 13772, 125)
		FIZ_AddQuest(978, 4, 8, 13772, 125)
	---- spillover from 1068.5	
		FIZ_AddQuest(978, 4, 8, 11391, 62.5)
	---- spillover from 1126.5	
	...
	---- spillover from dungeon	
		...
		FIZ_AddInstance(978, 4, 8, instance.spill_rep_dun, 800, true)
	---- spillover from 1050	
		FIZ_AddQuest(978, 4, 8, 11153, 125)
		FIZ_AddQuest(978, 4, 8, 13309, 125)
		FIZ_AddQuest(978, 4, 8, 13284, 125)
		FIZ_AddQuest(978, 4, 8, 13336, 125)
		FIZ_AddQuest(978, 4, 8, 13280, 125)
		FIZ_AddQuest(978, 4, 8, 12444, 125)
		FIZ_AddQuest(978, 4, 8, 12296, 125)
		FIZ_AddQuest(978, 4, 8, 12289, 125)
		FIZ_AddQuest(978, 4, 8, 12268, 125)
		FIZ_AddQuest(978, 4, 8, 12244, 125)
	---- spillover from 1068.5	
		FIZ_AddQuest(978, 4, 8, 11391, 62.5)
	---- spillover from 1126.5	
		FIZ_AddQuest(978, 4, 8, 12869, 62.5)
	...
	---- spillover from 1067	
	---- spillover from 1052	
		FIZ_AddQuest(922, 4, 8, 12170, 62.5)
	---- spillover from 1124	
		FIZ_AddQuest(922, 4, 8, 13757, 62.5, {[44981] = 1})
		FIZ_AddQuest(922, 4, 8, 13625, 62.5)
		FIZ_AddQuest(922, 4, 8, 13769, 62.5)
		FIZ_AddQuest(922, 4, 8, 13772, 62.5)
		FIZ_AddQuest(922, 4, 8, 13671, 62.5)
		FIZ_AddQuest(922, 4, 8, 13759, 62.5)
		FIZ_AddQuest(922, 4, 8, 13772, 62.5)
	---- spillover from 1085	
		FIZ_AddQuest(922, 4, 8, 12284, 62.5)
		FIZ_AddQuest(922, 4, 8, 12280, 62.5)
		FIZ_AddQuest(922, 4, 8, 12288, 62.5)
		FIZ_AddQuest(922, 4, 8, 12270, 62.5)
		FIZ_AddQuest(922, 4, 8, 13309, 62.5)
		FIZ_AddQuest(922, 4, 8, 13284, 62.5)
		FIZ_AddQuest(922, 4, 8, 13336, 62.5)
		FIZ_AddQuest(922, 4, 8, 13280, 62.5)
	---- spillover from tournament	
		FIZ_AddQuest(922, 4, 8, 13809, 125)
		FIZ_AddQuest(922, 4, 8, 13810, 125)
		FIZ_AddQuest(922, 4, 8, 13862, 125)
		FIZ_AddQuest(922, 4, 8, 13811, 125)
	---- spillover from dungeon	
		FIZ_AddInstance(922, 4, 8, instance.spill_rep_dun, 400, false)
		FIZ_AddInstance(922, 4, 8, instance.spill_rep_dun, 800, true)
	---- spillover from 1052	
		FIZ_AddQuest(922, 4, 8, 12170, 125)
	---- spillover from 1124	
		FIZ_AddQuest(922, 4, 8, 13757, 62.5, {[44981] = 1})
		FIZ_AddQuest(922, 4, 8, 13625, 62.5)
		FIZ_AddQuest(922, 4, 8, 13769, 62.5)
	...
	---- spillover from dungeon	
		...
		FIZ_AddInstance(922, 4, 8, instance.spill_rep_dun, 800, true)
	---- spillover from 1124	
		FIZ_AddQuest(922, 4, 8, 13757, 125, {[44981] = 1})
		FIZ_AddQuest(922, 4, 8, 13625, 125)
		FIZ_AddQuest(922, 4, 8, 13769, 125)
		FIZ_AddQuest(922, 4, 8, 13772, 125)
		FIZ_AddQuest(922, 4, 8, 13671, 125)
		FIZ_AddQuest(922, 4, 8, 13759, 125)
		FIZ_AddQuest(922, 4, 8, 13772, 125)
	---- spillover from 1052	
		FIZ_AddQuest(922, 4, 8, 12170, 62.5)
	---- spillover from 1085	
	...
	---- spillover from 1068	
	---- spillover from 1085	
		FIZ_AddQuest(922, 4, 8, 12284, 125)
		FIZ_AddQuest(922, 4, 8, 12280, 125)
		FIZ_AddQuest(922, 4, 8, 12288, 125)
		FIZ_AddQuest(922, 4, 8, 12270, 125)
		FIZ_AddQuest(922, 4, 8, 13309, 125)
		FIZ_AddQuest(922, 4, 8, 13284, 125)
		FIZ_AddQuest(922, 4, 8, 13336, 125)
		FIZ_AddQuest(922, 4, 8, 13280, 125)
	---- spillover from 1052	
		FIZ_AddQuest(922, 4, 8, 12170, 62.5)
	---- spillover from 1124	
		FIZ_AddQuest(922, 4, 8, 13757, 62.5, {[44981] = 1})
