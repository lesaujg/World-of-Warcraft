...
L["COD Amount (per Item):"] = "Montant (Par item) :"
-- L["COD: %s | %s | (%s) | %s | %s"] = ""
...
L["Enable Inbox Chat Messages"] = "Activer la Chatbox"
L["Enable Sending Chat Messages"] = "Activer l'envoie des messages chat" -- Needs review
...
L["Enter the name of the player you want to send excess gold to."] = "Entrez le nom du joueur à qui vous envoyer l'argent" -- Needs review
L["Enter the name of the player you want to send this item to."] = "Entre le nom du joueur à qui vous envoyez cette item"
L["Expired: %s | %s"] = "Expiration : %s | %s"
-- L["Expires"] = ""
...
L["Item (Drag Into Box):"] = "Item (Déplacer içi) : "
-- L["Keep Free Bag Space"] = ""
-- L["Keep Quantity"] = ""
-- L["Lastly, click this button to send the mail."] = ""
L["Limit (In Gold):"] = "Limite (en Pièce d'or) :"
...
L["Mailing all to %s."] = "Tout les mails à %s."
...
L["Mail Selected Groups"] = "Groupes de mail sélectionnés"
...
L["Multiple Items"] = "Items multiples"
L["No Item Specified"] = "Aucun item spécifié"
-- L["No Target Player"] = ""
...
L["Sends each unique item in a seperate mail."] = "Envoyer les items unique séparément"
-- L["Send %sx%d to %s - No COD"] = ""
-- L["Send %sx%d to %s - %s per Item COD"] = ""
-- L["Sent all disenchantable items to %s."] = ""
L["Sent %s to %s."] = "Envoyer %s à %s"
...
L["This button will de-select all groups."] = "Ce bouton sert à désélectionner tout les groupes"
...
L["Total Gold Collected: %s"] = "Pièce d'or collecté au total : %s"
-- L["TSM Groups"] = ""
