...
if locale == "ruRU" then
    ...
    L["LM_EXPORT_PROFILE"] = "Профиль экспорта"
    ...
    L["LM_IMPORT_PROFILE_EXP"] = "Вставьте ранее экспортированный профиль в поле ниже, чтобы импортировать его как введенное имя."
