...
L.LM_SETTINGS_TAGLINE   = "简单可靠的随机安装召唤。"
L.LM_TRANSLATORS        = "译者"
...
L.FLOAT                 = "漂浮"
L.FLY                   = "飛行"
L.LM_ADVANCED_EXP       = "这些设置允许您自定义每个LiteMount键绑定运行的操作。请在更改任何内容之前阅读以下URL中的文档。"
L.LM_AUTHOR             = "作者"
L.LM_COMBAT_MACRO_EXP   = "如果啟用，此巨集將替代預設的戰鬥行動，如果LiteMount是啟用的而且你在戰鬥中。"
L.LM_COPY_TARGETS_MOUNT = "尝试复制目标的挂载。"
L.LM_CURRENT_SETTINGS   = "当前设置"
L.LM_DEBUGGING_DISABLED = "禁用调试"
L.LM_DEBUGGING_ENABLED  = "启用调试"
L.LM_DEFAULT_SETTINGS   = "默认设置"
L.LM_DELETE_FLAG        = "删除标签"
