...
private.L["HELLBANE_SCAN"] = "Оповещать о появлении существ, необходимых для достижения \"Гроза преисподней\"" -- Needs review
...
private.L["VIGNETTE_SCAN_DESC"] = "Оповещать о появлении в зоне видимости редких существ (отображаемых в виде черепа на миникарте)" -- Needs review
