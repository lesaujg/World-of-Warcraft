...
private.L["BLOCKFLIGHTSCAN"] = "Supprimer les alertes lors des trajets en vol."
...
private.L["SEARCH_WORLD_DESC"] = "Un nom de monde optionnel afin de limiter les recherches. Peut être un nom de continent ou |cffff7f3fun nom d'instance|r (sensible à la case)."
