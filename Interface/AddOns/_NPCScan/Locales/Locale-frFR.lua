...
private.L["BLOCKFLIGHTSCAN"] = "Supprime les alertes lors des trajets en vol." -- Needs review
...
private.L["CONFIG_ALERT_PERSISTENT_TOAST"] = "Garder les message Toast persistants." -- Needs review
private.L["CONFIG_ALERT_PERSISTENT_TOAST_DESC"] = "Les messages Toast ne disparaîtront pas après avoir été affichés." -- Needs review
private.L["CONFIG_ALERT_SCREEN_EDGE_FLASH"] = "Afficher un flash rouge sur la bordure d'écran" -- Needs review
private.L["CONFIG_ALERT_SCREEN_EDGE_FLASH_DESC"] = "Affiche un flash rouge sur la bordure de l'écran lorsqu'un PNJ est trouvé." -- Needs review
private.L["CONFIG_ALERT_SHOW_AS_TOAST"] = "Afficher comme message Toast"
private.L["CONFIG_ALERT_SHOW_AS_TOAST_DESC"] = "Afficher dans une fenêtre Toast plutôt quand dans la fenêtre de discussion." -- Needs review
...
private.L["FOUND_UNIT_DEAD"] = "%s trouvé(e) mais déjà mort(e)." -- Needs review
private.L["FOUND_UNIT_TAXI"] = "%s trouvé(e) durant le trajet en vol près de %d, %d à %s." -- Needs review
private.L["MOUSEOVER_SCAN"] = "Afficher les alertes des monstres à leur survol par la souris" -- Needs review
private.L["MOUSEOVER_SCAN_DESC"] = "Affiche les alertes des monstres à leur survol par la souris, même s'ils sont déjà dans le cache." -- Needs review
...
private.L["SEARCH_IGNORE_LIST"] = "Liste des ignorés" -- Needs review
private.L["SEARCH_IGNORE_LIST_DESC"] = "Liste des monstres que NPCScan ne cherchera pas." -- Needs review
