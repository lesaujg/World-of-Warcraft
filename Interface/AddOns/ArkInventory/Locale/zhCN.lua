...
--	configuration options > control
	...
	L["CONFIG_CONTROL_NOTIFY_ERASE"] = "通知"
...
--	L["CONFIG_CONTROL_SPECIAL_TEXT"] = ""
	...
	L["CONFIG_CONTROL_REPOSITION_ONLOAD"] = "加载时复位"
	L["CONFIG_CONTROL_REPOSITION_ONLOAD_TEXT"] = "首次查看时，复位 %1$s 窗口" -- %1$s = location name
...
--	configuration options > settings
	...
	L["CONFIG_SETTINGS_FRAME_HIDE_TEXT"] = "查看 %1$s 窗口时，不显示 %2$s 的层"
...
--	L["CONFIG_SETTINGS_FRAME_HEIGHT_TEXT"] = ""
	...
	L["CONFIG_SETTINGS_FRAME_CHANGER_HIGHLIGHT_TEXT"] = "当鼠标指向背包时，高亮该背包所有包格"
	...
	L["CONFIG_SETTINGS_FRAME_STATUS_EMPTY"] = "清空标签文字"
	L["CONFIG_SETTINGS_FRAME_STATUS_EMPTY_TEXT"] = "显示空标签文字"
	
	L["CONFIG_SETTINGS_FRAME_TITLE_SIZE_NORMAL"] = "普通"
	L["CONFIG_SETTINGS_FRAME_TITLE_SIZE_THIN"] = "细"
	...
	L["CONFIG_SETTINGS_BARS_NAME_HEIGHT_TEXT"] = "设置标签名称空间尺寸"
	L["CONFIG_SETTINGS_BARS_NAME_ANCHOR_TEXT"] = "设置标签名称锚点"
...
--	L["CONFIG_SETTINGS_ITEMS_ITEMLEVEL_SHOW_TEXT"] = ""
	...
	L["CONFIG_SETTINGS_ITEMS_COOLDOWN_SHOW_TEXT"] = "显示 %1$s 窗口中的物品冷却"
	L["CONFIG_SETTINGS_ITEMS_COOLDOWN_GLOBAL"] = "按照 GCD 更新"
	L["CONFIG_SETTINGS_ITEMS_COOLDOWN_GLOBAL_TEXT"] = "GCD 更新时，刷新 %1$s 窗口内物品冷却"
	L["CONFIG_SETTINGS_ITEMS_COOLDOWN_COMBAT"] = "战斗时刷新"
	L["CONFIG_SETTINGS_ITEMS_COOLDOWN_COMBAT_TEXT"] = "战斗时，或战斗结束时刷新 %1$s 窗口内物品冷却"
	...
	L["CONFIG_SETTINGS_ITEMS_BORDER_RARITY_CUTOFF"] = "稀有度界线"
	L["CONFIG_SETTINGS_ITEMS_BORDER_RARITY_CUTOFF_TEXT"] = "只对稀有度不低于 %s 的物品边框进行染色"
...
--	L["CONFIG_SETTINGS_ITEMS_NEW_RESET_TEXT"] = ""
	...
	L["CONFIG_SETTINGS_ITEMS_AGE_CUTOFF_TEXT"] = "显示低于此时间的物品获取时间. 0 表示始终显示"
	...
	L["CONFIG_SETTINGS_EMPTY_STATUS"] = "显示格式"
...
--	L["CONFIG_SORTING_INCLUDE_ID_TEXT"] = ""
	...
	L["CONFIG_SORTING_ADD"] = "添加排序规则"
	L["CONFIG_SORTING_ADD_TEXT"] = "添加新排序规则"
	L["CONFIG_SORTING_RENAME_TEXT"] = "修改排序名称"
	L["CONFIG_SORTING_DELETE_TEXT"] = "删除排序规则"
...
--	configuration options > categories
	...
	L["CONFIG_CATEGORY_ADD"] = "添加分类"
	L["CONFIG_CATEGORY_ADD_TEXT"] = "添加新分类"
	L["CONFIG_CATEGORY_RENAME_TEXT"] = "修改分类名称"
	L["CONFIG_CATEGORY_DELETE_TEXT"] = "删除分类"
