...
--rscignorezonedef={{1094,1088,1114},{"The Emerald Nightmare","The Nighthold","Trial of Valor"}}
rscignorezonedef={{1147},{"Tomb of Sargeras"}}




rscTimoutReportsInSec=50
...
-- IMPORTANT! Sometimes Blizz uses the same ID for 100 and 125 stats, so lets check how much stats it really gives, by default we check food only if it >= than
rscMinFoodBuffAccepted=301
...
rscfoodtable_additional={
  ...
  -- Legion, +300     в файле flaskcheck менять цифру чтобы в меню изменилась какая доп. еда
  225597,
  225598,
  225599,
  225600,
...
if rscflaskcheckfoodadd2==nil then rscflaskcheckfoodadd2=0 end
	...
	if rscflaskcheckb==nil then rscflaskcheckb={1,1,1,0,0,1,1,0} end
	if rscflaskcheckb[8]==nil then rscflaskcheckb[8]=0 end
...
if rscignorezone13==nil then
	rscignorezone13={{},{}}
	for i=1,#rscignorezonedef[1] do
		table.insert(rscignorezone13[1],rscignorezonedef[1][i])
		table.insert(rscignorezone13[2],rscignorezonedef[2][i])
	end
...
if #rscignorezone13[1]>0 then
	for ug=1,#rscignorezone13[1] do
		if rscignorezone13[1][ug]==curZone then
...
function rscchatsendreports(chat,nnn1, nnn2, nnn3, nnn4, nnn5, nnn6, nnn7, nnn8, nnn9, nnn10,nnn11,nnn12,nnn13,nnn14)
...
if nnn13==nil then nnn13=" " end
if nnn14==nil then nnn14=" " end
local nnn={nnn1,nnn2,nnn3,nnn4,nnn5, nnn6, nnn7, nnn8, nnn9, nnn10,nnn11,nnn12,nnn13,nnn14}
for i=1,#nnn do
...
elseif colid=="12" then rscout2:AddMessage("|CFFA330C9"..imya.."|r")
else
