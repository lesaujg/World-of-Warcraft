...
ASL["DBM/VEM Half-Bar Skin Spacing looks wrong. How can I fix it?"] = true
ASL["DBM|VEM Font Flag"] = true
ASL["DBM|VEM Font Size"] = true
ASL["DBM|VEM Font"] = true
ASL["DBM|VEM Half-bar Skin"] = true
...
ASL["Settings to control Embedded AddOns:\n\nAvailable Embeds: alDamageMeter | Details | Omen | Skada | Recount | TinyDPS"] = true
ASL["Skada Backdrop"] = true
ASL["Skin Template"] = true
ASL["THICKOUTLINE"] = true
ASL["To use the DBM/VEM Half-Bar skin. You must change the DBM/VEM Options. Offset Y needs to be at least 15."] = true
