...
RAFdb.AchID[88] = {12004,12005,12009,12007,12008}--Seat
RAFdb.AchID[89] = {10773,10775,10776,10803}--The Arcway
...
if uFaction == "A" then 
	...
	RAFdb.AchID[92] = {7989,7990,7991,7992,7993,7988}--Patience
	RAFdb.AchID[93] = {7273,7272,7271}--Arena
	RAFdb.AchID[94] = {8016,8017}--Assault
	RAFdb.AchID[95] = {8347,8314,8364}--Battle
	RAFdb.AchID[96] = {8329,8330,8316,8312}--Blood
	RAFdb.AchID[97] = {6931,6930,6923}--Brewmoon
	RAFdb.AchID[98] = {7275,7276,8368,7522,8311}--Crypt
	RAFdb.AchID[99] = {7987,7984,7986,8009}--Dagger
	RAFdb.AchID[100] = {8319,8317,8318}--DarkHeart
	RAFdb.AchID[101] = {7267,7266,7265}--Greenstone
	RAFdb.AchID[102] = {8012,8011,8010}--Lion's
	...
	RAFdb.MapName[102] = "Lion's Landing"-- (Krasarang Wilds)
	RAFdb.MapName[104] = "Theramore's Fall"-- (Dustwallow Marsh)
else
	RAFdb.AchID[91] = {7261,7258,7257,7252,8310}--Brewing
	RAFdb.AchID[92] = {7989,7990,7991,7992,7993,7988}--Patience
	RAFdb.AchID[93] = {7273,7272,7271}--Arena
	RAFdb.AchID[94] = {8016,8017}--Assault
	RAFdb.AchID[95] = {8347,8315,8366}--Battle
	RAFdb.AchID[96] = {8329,8330,8316,8312}--Blood
	RAFdb.AchID[97] = {6931,6930,6923}--Brewmoon
	RAFdb.AchID[98] = {7275,7276,8368,7522,8311}--Crypt
	RAFdb.AchID[99] = {7987,7984,7986,8009}--Dagger
	RAFdb.AchID[100] = {8319,8317,8318}--DarkHeart
	RAFdb.AchID[101] = {8015,8014,8013}--Domination
	RAFdb.AchID[102] = {7267,7266,7265}--Greenstone
	RAFdb.AchID[103] = {8295,8294,8327}--Ragefire
	...
	RAFdb.MapName[96] = "Blood in the Snow"--(Dun Morogh)
	RAFdb.MapName[100] = "Dark Heart of Pandaria"--(Vale of Eternal Blossoms)
	RAFdb.MapName[101] = "Domination Point"--(Krasarang Wilds)
	RAFdb.MapName[102] = "Greenstone Village"--(Jade Forest)
	RAFdb.MapName[104] = "Theramore's Fall"--(Dustwallow Marsh)
end
