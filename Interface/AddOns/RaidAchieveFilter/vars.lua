...
--Lich King Dungeons
RAFdb.AchID[36] = {2038,2056,1862,481,492} --Ahn'kahet
RAFdb.AchID[37] = {1296,1297,1860,480,491} --Azjol'nerub
RAFdb.AchID[38] = {1872,1817,479,500} --Culling of Strat
RAFdb.AchID[39] = {2151,2057,2039,482,493} --Drak'tharon
RAFdb.AchID[40] = {4522,4523,4516,4519} --Forge of Souls
RAFdb.AchID[41] = {2058,2040,1864,2152,484,495} --Gun'drak
RAFdb.AchID[42] = {1834,2042,1867,486,497} --Halls of Lightning
RAFdb.AchID[43] = {4526,4518,4521} --Halls of Reflection
RAFdb.AchID[44] = {2154,1866,2155,485,496} --Halls of Stone
RAFdb.AchID[45] = {2150,2037,2036,478,490} --Nexus
RAFdb.AchID[46] = {1868,2046,2045,2044,1871,487,498} --Oculus
RAFdb.AchID[47] = {4524,4525,4517,4520} --Pit of Saron
if uFaction == "A" then RAFdb.AchID[48] = {3802,3803,3804,4296,4298}
else RAFdb.AchID[48] = {3802,3803,3804,3778,4297} end --Trial of the Champion
RAFdb.AchID[49] = {1919,477,489} --Utgarde Keep
RAFdb.AchID[50] = {2043,1873,2156,2157,488,499} --Utgarde Pinnacle
RAFdb.AchID[51] = {2153,2041,1865,1816,483,494} --Violet Hold
-- Cataclysm Dungeons
RAFdb.AchID[52] = {5281,5282,5283,5284,4833,5060} --Blackrock Caverns
RAFdb.AchID[53] = {5366,5367,5368,5369,5370,5371,5083} -- Deadmines
RAFdb.AchID[54] = {5995,6130,6117} --End Time
RAFdb.AchID[55] = {5297,5298,4840,5062} --Grim Batol
RAFdb.AchID[56] = {5293,5294,5296,5295,4841,5065} --Halls of Origination
RAFdb.AchID[57] = {6132,6119} --Hour of Twilight
RAFdb.AchID[58] = {5291,5290,5292,4848,5066} --Lost City of Tol'vir
RAFdb.AchID[59] = {5503,5504,5505,5093}--Shadowfang Keep
RAFdb.AchID[60] = {5287,4846,5063} --Stonecore
RAFdb.AchID[61] = {5285,5286,4839,5061} --Throne of Tides
RAFdb.AchID[62] = {5289,5288,4847,5064} --Vortex Pinnacle
RAFdb.AchID[63] = {6127,6070,6118} --Well of Eternity
RAFdb.AchID[64] = {5761,5750,5858,5760,5769} --Zul'Aman
RAFdb.AchID[65] = {5743,5762,5765,5744,5759,5768} --Zul'gurub
-- MoP Dungeons
RAFdb.AchID[66] = {6479,6476,6945,10010,6759} --Gate of the Setting Sun
RAFdb.AchID[67] = {6713,6478,6736,6755,6756} --Mogu'shan Palace
RAFdb.AchID[68] = {6684,6427,6760} --Scarlet Halls
RAFdb.AchID[69] = {6929,6928,6946,6761} --Scarlet Monastery
RAFdb.AchID[70] = {6394,6396,6531,6715,6821,6762} --Scholomance
RAFdb.AchID[71] = {6471,6477,6472,6469,6470} --Shado-Pan
RAFdb.AchID[72] = {6485,6822,6688,10011,6763} --Siege of Niuzao Temple
RAFdb.AchID[73] = {6420,6400,6089,6402,6457,6456} --Stormstout Brewery
RAFdb.AchID[74] = {6475,6460,6671,6757,6758} --Temple of the Jade Serpent
-- WoD Dungeons
RAFdb.AchID[75] = {9023,9551,9552,9039,9049,10080}--Auchindoun
RAFdb.AchID[76] = {8993,9005,9008,9037,9046,10076}--Bloodmaul Slag Mines
RAFdb.AchID[77] = {9024,9007,9043,9052,10082}--Grimrail Depot
RAFdb.AchID[78] = {9083,9081,9082,9038,9047,10079}--Iron Docks
RAFdb.AchID[79] = {9018,9025,9026,9041,9054,10084}--Shadowmoon Burial Grounds
RAFdb.AchID[80] = {9033,9034,9035,9036,8843,8844,10081}--Skyreach
RAFdb.AchID[81] = {9017,9493,9223,9044,9053,10083}--The Everbloom
RAFdb.AchID[82] = {9045,9058,9056,9057,9042,9055,10085}--UBRS
-- Legion Dungeons
RAFdb.AchID[83] = {10554,10553,10798,10799,10800}--Violet Hold
RAFdb.AchID[84] = {10710,10711,10709,10804,10805,10806}--Black Rook Hold
RAFdb.AchID[85] = {11768,11769,11703,11700,11701,11702}--Cathedral
RAFdb.AchID[86] = {10610,10611,10816}--Court of Stars
RAFdb.AchID[87] = {10766,10769,10783,10784,10785}--Darkheart Thicket
RAFdb.AchID[88] = {10456,10457,10458,10780,10781,10782}--Eye of Azshara
RAFdb.AchID[89] = {10542,10544,10543,10786,10788,10789}--Halls of Valor
RAFdb.AchID[90] = {11335,11338,11432,11431,11433,11429,11430}--Karazhan
RAFdb.AchID[91] = {10411,10413,10412,10807,10808,10809}--Maw of Souls
RAFdb.AchID[92] = {10996,10875,10795,10796,10797}--Neltharion's Lair
RAFdb.AchID[93] = {12004,12005,12009,12007,12008}--Seat
RAFdb.AchID[94] = {10773,10775,10776,10803}--The Arcway
RAFdb.AchID[95] = {10707,10679,10680,10801,10802,10803}--Vault of the Wardens
-- BfA Dungeons
RAFdb.AchID[96] = {12824,12825,12826}--Atal'dazar
RAFdb.AchID[97] = {12548,12998,12831,12832,12833}--Freehold
RAFdb.AchID[98] = {12848}--King's Rest
RAFdb.AchID[99] = {13698,13545,13723,13706}--Operation Mechagon
RAFdb.AchID[100] = {12600,12601,12602,12835,12837,12838}--Shrine of the Storm
RAFdb.AchID[101] = {12727,12726,12847}--Siege of Boralus
RAFdb.AchID[102] = {12504,12505,12506}--Temple of Sethraliss
RAFdb.AchID[103] = {12844,12845,12846}--The Motherlode!!
RAFdb.AchID[104] = {12498,12549,12499,12500,12501,12502}--The Underrot
RAFdb.AchID[105] = {12457,12462,12840,12841,12842}--Tol Dagor
RAFdb.AchID[106] = {12489,12495,12490,12483,12484,12488}--Waycrest Manor
RAFdb.MapID = {
--Raids
...
--Scenarios
if uFaction == "A" then 
	RAFdb.AchID[107] = {7261,7258,7257,7252,8310}--Brewing
	RAFdb.AchID[108] = {7989,7990,7991,7992,7993,7988}--Patience
	RAFdb.AchID[109] = {7273,7272,7271}--Arena
	RAFdb.AchID[110] = {8016,8017}--Assault
	RAFdb.AchID[111] = {8347,8314,8364}--Battle
	RAFdb.AchID[112] = {8329,8330,8316,8312}--Blood
	RAFdb.AchID[113] = {6931,6930,6923}--Brewmoon
	RAFdb.AchID[114] = {7275,7276,8368,7522,8311}--Crypt
	RAFdb.AchID[115] = {7987,7984,7986,8009}--Dagger
	RAFdb.AchID[116] = {8319,8317,8318}--DarkHeart
	RAFdb.AchID[117] = {7267,7266,7265}--Greenstone
	RAFdb.AchID[118] = {8012,8011,8010}--Lion's
	RAFdb.AchID[119] = {8295,8294,8327}--Ragefire
	RAFdb.AchID[120] = {7526,7527,7523}--Theramore
	RAFdb.AchID[121] = {7231,7232,7239,7249,7248}--Unga
	...
	for i = 1, 121 do RAFdb.MapName[i] = C_Map.GetMapInfo(RAFdb.MapID[i]).name; end
	RAFdb.MapName[109] = "Arena of Annihilation"-- (Proving Grounds)
	RAFdb.MapName[112] = "Blood in the Snow"-- (Dun Morogh)
	RAFdb.MapName[116] = "Dark Heart of Pandaria"-- (Vale of Eternal Blossoms)
	RAFdb.MapName[117] = "Greenstone Village"-- (Jade Forest)
	RAFdb.MapName[118] = "Lion's Landing"-- (Krasarang Wilds)
	RAFdb.MapName[120] = "Theramore's Fall"-- (Dustwallow Marsh)
else
	RAFdb.AchID[107] = {7261,7258,7257,7252,8310}--Brewing
	RAFdb.AchID[108] = {7989,7990,7991,7992,7993,7988}--Patience
	RAFdb.AchID[109] = {7273,7272,7271}--Arena
	RAFdb.AchID[110] = {8016,8017}--Assault
	RAFdb.AchID[111] = {8347,8315,8366}--Battle
	RAFdb.AchID[112] = {8329,8330,8316,8312}--Blood
	RAFdb.AchID[113] = {6931,6930,6923}--Brewmoon
	RAFdb.AchID[114] = {7275,7276,8368,7522,8311}--Crypt
	RAFdb.AchID[115] = {7987,7984,7986,8009}--Dagger
	RAFdb.AchID[116] = {8319,8317,8318}--DarkHeart
	RAFdb.AchID[117] = {8015,8014,8013}--Domination
	RAFdb.AchID[118] = {7267,7266,7265}--Greenstone
	RAFdb.AchID[119] = {8295,8294,8327}--Ragefire
	RAFdb.AchID[120] = {7529,7530,7524}--Theramore
	RAFdb.AchID[121] = {7231,7232,7239,7249,7248}--Unga
	...
	RAFdb.MapName[112] = "Blood in the Snow"--(Dun Morogh)
	RAFdb.MapName[116] = "Dark Heart of Pandaria"--(Vale of Eternal Blossoms)
	RAFdb.MapName[117] = "Domination Point"--(Krasarang Wilds)
	RAFdb.MapName[118] = "Greenstone Village"--(Jade Forest)
	RAFdb.MapName[120] = "Theramore's Fall"--(Dustwallow Marsh)
end
RAFdb.MapName[84] = "Assault on Violet Hold"
RAFdb.MapName[92] = "Maw of Souls"
--RAFdb.MapName[99] = "King's Rest"
--RAFdb.MapName[101] = "Siege of Boralus"
