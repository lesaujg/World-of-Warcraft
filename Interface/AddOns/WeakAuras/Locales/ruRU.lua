...
L["Can be used for e.g. checking if \"boss1target\" is the same as \"player\"."] = "Может использоваться для проверки равенства двух единиц. Например: \"игрок\" является целью 1-го босса - \"boss1target\"."
