...
L["Debuff"] = "減益"
L["Debuff Class"] = "減益效果類別"
L["Debuff Class Icon"] = "減益效果類別圖示"
L["Debuff Type"] = "減益類型"
L["Deflect"] = "偏斜"
L["Desaturate"] = "去色"
...
L["Emote"] = "表情動作"
L["Emphasized"] = "強調"
L["Emphasized option checked in BigWigs's spell options"] = "BigWigs 法術選項中勾選的強調選項"
L["Empty"] = "空"
...
L["Options will finish loading after the login process has completed."] = "設定選項會在登入程序完成後載入完畢。"
L["Orbit"] = "軌道"
L["Orientation"] = "方向"
L["Outline"] = "外框"
L["Outside"] = "外面"
