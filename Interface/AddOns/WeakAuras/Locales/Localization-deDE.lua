...
L["%s Alpha Animation"] = "%s Transparenzanimation" -- Needs review
L["Say"] = "Sagen"
L["%s Color Animation"] = "%s Farbanimation" -- Needs review
L["%s - Custom Text"] = "%s - Benutzerdefinierter Text" -- Needs review
...
L["Shrink"] = "Schrumpfen"
L["%s Icon Function"] = "%s Symbolfunktion" -- Needs review
-- L["%s - Init Action"] = ""
L["%s - %i. Trigger"] = "%s - %i. Auslöser" -- Needs review
...
L["%s Name Function"] = "%s Namensfunktion" -- Needs review
L["Solar"] = "Solar"
