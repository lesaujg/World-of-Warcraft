...
La["Bind a key to toggle the SavedInstances tooltip"] = "Associe une touche à l'affichage de l'info-bulle de SavedInstance."
...
La["Disable tooltip display on icon mouseover"] = "Désactive l'affichage de l'info-bulle lors du survol de la souris."
...
La["Display instances with space inserted between categories"] = "Afficher les instances avec un espace entre les catégories."
...
La["Opacity of the tooltip row highlighting"] = "Opacité de la mise en évidence des rangées de l'info-bulle."
La["Open config"] = "Ouvrir la configuration"
La["Plant"] = "Plantes"
La["Raids before dungeons"] = "Raids avant les donjons"
La["Recent Bonus Rolls"] = "Jet de dé bonus récents"
...
La["Show category names in the tooltip"] = "Affiche les noms des catégories dans l'info-bulle."
La["Show cooldown for characters to use battleground system"] = "Affiche le temps restant avant que les personnages déserteurs ne puissent rejoindre un champs de bataille."
...
La["Show/Hide the SavedInstances tooltip"] = "Afficher/cacher l'info-bulle de SavedInstances"
...
La["Show minimap button"] = "Afficher le bouton sur la mini-carte"
...
La["Show tooltip hints"] = "Astuces de l'info-bulle"
