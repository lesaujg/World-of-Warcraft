MDL_DB_BOSSES = {
	...
	[126916] = { name = "F'harg" },
	[140474] = { name = "Adherent of the Abyss" },
	[142709] = { name = "Beastrider Kama" },
}
...
MDL_DB_MOUNTS = {
	...
	[161479] = { -- Nazjatar Blood Serpent
        ...
        from = {
            {
                type = 'special', subtype = 'summoned', npc_id = 140474,
                zone_id = 942,
                level = 120, for_sort = 700,
	...
	[163644] = { -- Swift Albino Raptor
        ...
        from = {
            {
                type = 'special', subtype = 'warfront', npc_id = 142709,
                zone_id = 1044,
                level = 120, for_sort = 710,
            },
        },
    },
	[159921] = { -- Tomb Stalker
        ...
        from = {
            {
                type = 'dungeon', subtype = 'mythic', npc_id = 136160,
                zone_id = 1004,
                level = 120, for_sort = 715,
            },
        },
    },
	...
	[163645] = { -- Skullripper
        ...
        from = {
            {
                type = 'special', subtype = 'warfront', npc_id = 142437,
                zone_id = 1044,
                level = 120, for_sort = 710,
            },
        },
	...
	[163706] = { -- Witherbark Direwing
        ...
        from = {
            {
                type = 'special', subtype = 'warfront', npc_id = 142692,
                zone_id = 1044,
                level = 120, for_sort = 710,
            },
        },
	...
	[163646] = { -- Lil' Donkey
        ...
        from = {
            {
                type = 'special', subtype = 'warfront', npc_id = 142423,
                zone_id = 1044,
                level = 120, for_sort = 710,
            },
        },
	...
	[160829] = { -- Underrot Crawg
        ...
        from = {
            {
                type = 'dungeon', subtype = 'mythic', npc_id = 133007,
                zone_id = 1042,
                level = 120, for_sort = 735,
            },
        },
    },
	[159842] = { -- Sharkbait
        ...
        from = {
            {
                type = 'dungeon', subtype = 'mythic', npc_id = 129440,
                zone_id = 936,
                level = 120, for_sort = 735,
            },
        },
