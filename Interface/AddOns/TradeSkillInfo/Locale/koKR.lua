...
L["Color Auction Recipes"] = "제조법 색상"
L["Color Bag Recipes"] = "가방 제조법 색상화"
L["Color Merchant Recipes"] = "상인 제조법 색상"
L["Color recipes in bags and banks"] = "가방 및 은행에 있는 제조법을 색상화 합니다."
L["Color recipes in Merchant windows"] = "상인의 제조법에 색상을 표시합니다."
...
L["Only add extra data to recipes"] = "제조법에만 추가 데이터 표시"
L["Only show extra profession data in recipe tooltips instead of every crafted item ever"] = "모든 재료아이템 대신에 제조법의 툴팁에 추가 전문기술을 표시합니다."
L["Opposing"] = "상대진영"
L["Pick Pocket"] = "훔치기"
...
L["Turn on debug info output"] = "디버그정보 출력 표시"
L["UI"] = true
L["UI Options"] = "UI 설정"
L["UI Scale"] = "UI 크기"
L["Unavailable"] = "사용 불가"
