...
local save_profile_ref 	= "PreSaveABProfile"
local load_profile_ref 	= "PreLoadABProfile"
...
-----------------------------
	...
	function(msg)
	   ...
	   arg = arg or ""
		...
		if (cmd == "version") then
			addon_obj:Echo("Version v."..PABversion)
		elseif (cmd=="list")then
			addon_obj:ListProfiles()
		elseif (cmd=="minimap"  and arg~="")then
			addon_obj:Minimap(arg)
		elseif (cmd=="" or arg=="")then
			addon_obj:Echo(SLASH_PAB1.." delete <name>")
			addon_obj:Echo(SLASH_PAB1.." save <name>")
			addon_obj:Echo(SLASH_PAB1.." load <name>")
			addon_obj:Echo(SLASH_PAB1.." import")
			addon_obj:Echo(SLASH_PAB1.." export")
			addon_obj:Echo(SLASH_PAB1.." list")
			addon_obj:Echo(SLASH_PAB1.." version * Not implemented yet")
			addon_obj:Echo(SLASH_PAB1.." debug [on|off] * Not implemented yet")
		...
		elseif (cmd=="export" and arg~="")then
