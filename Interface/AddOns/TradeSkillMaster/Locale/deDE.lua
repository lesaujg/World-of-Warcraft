...
L["|cffffff00DO NOT report this as an error to the developers.|r If you require assistance with this, make a post on the TSM forums instead."] = "|cffffff00Meldet dies AUF KEINEN FALL den Entwicklern als Fehler.|r Wenn Ihr weitere Hilfe benötigt, erstelle einen Thread im TSM-Forum." -- Needs review
...
L["Craft Items from Queue"] = "Produziere Gegenstände aus der Warteschlänge" -- Needs review
...
L["Import Operation Settings"] = "Operation-Einstellungen iimportieren" -- Needs review
L["Import Preset TSM Theme"] = "Importiert voreingestelltes TSM Design"
L["Import String"] = "Kette importieren"
L["Include Subgroup Structure in Export"] = "Berücksichtige die Untergruppenstruktur beim Exportieren" -- Needs review
...
L["No Assistant guides available for the modules which you have installed."] = "Für eure installierten Module sind keine Guides verfügbar." -- Needs review
...
Sobald Ihr fertig seit, müsst Ihr den unteren Button anklicken.]=] -- Needs review
...
L["Select Group and Click Restock Button"] = "Wählt eine Gruppe aus und klickt auf Auffüllen-Button" -- Needs review
L["Select Group and Start Scan"] = "Wählt eine Gruppe aus und starten den Scan" -- Needs review
...
L["Start a Destroy Search"] = "Startet eine Destroy-Suche" -- Needs review
L["Start Sniper"] = "Startet den Sniper" -- Needs review
L["Start Vendor Search"] = "Startet die Vendor-Suche" -- Needs review
...
L["Switch to Destroy Mode"] = "Wechselt zum Destroy-Modus" -- Needs review
...
L["Type a raw material you would like to obtain via destroying in the search bar and start the search. For example: 'Ink of Dreams' or 'Spirit Dust'."] = "Schreibt ein Rohmaterial, das Ihr via Destroying erhalten wollt, in die Suchleiste und startet die Suche. Zum Beispiel: 'Traumtine' oder 'Geisterstaub'." -- Needs review
...
L["Underneath the 'Posting Options' header, there are two settings which control the Quick Posting feature of TSM_Shopping. The first one is the duration which Quick Posting should use when posting your items to the AH. Change this to your preferred duration for Quick Posting."] = "Unterhalb der Überschrift 'Posting-Optionen' findet Ihr zwei Einstellungen, die das Schnell-Posting-Feature von TSM_Shopping kontrollieren. Die erste Einstellung ist die Auktionsdauer, die das Schnell-Posting zum Posten Eurer Gegenstände in das AH verwenden soll. Ändert dies auf Eure bevorzugte Dauer für das Schnell-Posting." -- Needs review
L["Underneath the 'Posting Options' header, there are two settings which control the Quick Posting feature of TSM_Shopping. The second one is the price at which the Quick Posting will post items to the AH. This should generally not be a fixed gold value, since it will apply to every item. Change this setting to what you'd like to post items at with Quick Posting."] = "Unterhalb der Überschrift 'Posting-Optionen' findet Ihr zwei Einstellungen, die das Schnell-Posting-Feature von TSM_Shopping kontrollieren. Die zweite Einstellung ist der Auktionspreis, den das Schnell-Posting zum Posten Eurer Gegenstände in das AH verwenden soll. In der Regel sollte dies kein fester Goldbetrag sein, weil er für jeden Gegenstand gelten wird. Ändert dies auf Euren bevorzugte Wert für das Schnell-Posting." -- Needs review
L["Underneath the serach bar at the top of the 'Shopping' AH tab are a handful of buttons which change what's displayed in the sidebar window. Click on the 'Custom Filter' one."] = "Unterhalb der Suchleiste, ganz oben im AH-Tab 'Shopping', findet Ihr mehrere Buttons, die einstellen können, was im Seitenfenster angezeigt werden soll. Klickt auf den Button 'Benutzerdefinierter Filter'." -- Needs review
L["Underneath the serach bar at the top of the 'Shopping' AH tab are a handful of buttons which change what's displayed in the sidebar window. Click on the 'Other' one."] = "Unterhalb der Suchleiste, ganz oben im AH-Tab 'Shopping', findet Ihr mehrere Buttons, die einstellen können, was im Seitenfenster angezeigt werden soll. Klickt auf den Button 'Sonstiges'." -- Needs review
L["Underneath the serach bar at the top of the 'Shopping' AH tab are a handful of buttons which change what's displayed in the sidebar window. Click on the 'TSM Groups' one."] = "Unterhalb der Suchleiste, ganz oben im AH-Tab 'Shopping', findet Ihr mehrere Buttons, die einstellen können, was im Seitenfenster angezeigt werden soll. Klickt auf den Button 'TSM-Gruppen'." -- Needs review
L["Under the search bar, on the left, you can switch between normal and destroy mode for TSM_Shopping. Switch to 'Destroy Mode' now."] = "Unterhalb der Suchleiste, auf der linken Seite, könnt Ihr zwischen Normal- und Destroy-Modus für TSM_Shopping umschalten. Wechselt jetzt auf den 'Destroy-Modus'." -- Needs review
...
If you have this checked when adding an ungrouped randomly enchanted item, it will act as all possible random enchants of that item.]=] ] = [=[Wenn aktiviert, werden zufällige Verzauberungen bei ungruppierten Gegenständen ignoriert.

Achtung: Dies betrifft nicht die übergeordneten Gruppengegenstände, die bereits mit zufälligen Verzauberungen hinzugefügt wurden

Wenn Ihr dies beim Hinzufügen eines ungruppierten zufällig-verzauberten Gegenstandes aktiviert habt, wird es als alle möglichen Verzauberungen von diesem Gegenstand fungieren.]=] -- Needs review
