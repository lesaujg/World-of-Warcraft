...
function module:InitializeRecipes()
	local function AddRecipe(spellID, expansionID, quality)
		return addon:AddRecipe(module, {
			...
			profession = _G.GetSpellInfo(constants.PROFESSION_SPELL_IDS.SMELTING),
			quality = quality,
			_spell_id = spellID,
		})
	end
	...
	recipe:AddTrainer(1443, 1681, 1701, 3001, 3137, 3175, 3357, 3555, 4254, 4598, 5392, 5513, 8128, 16663, 16752, 17488, 18747, 18779, 18804, 26912, 26962, 26976, 26999, 28698, 33617, 33640, 33682, 43431, 46357, 47384, 47400, 47418, 47419, 47420, 47431, 48619, 52170, 52642, 53409, 57620, 65043, 65092, 85919, 86014)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1443, 1681, 1701, 3001, 3137, 3175, 3357, 3555, 4254, 4598, 5392, 5513, 8128, 16663, 16752, 17488, 18747, 18779, 18804, 26912, 26962, 26976, 26999, 28698, 33617, 33640, 33682, 43431, 46357, 52170, 52642, 53409, 65092, 85919, 86014)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1443, 1701, 3001, 3357, 4254, 5513, 8128, 17488, 18747, 18779, 26912, 26962, 26976, 26999, 28698, 33617, 33640, 33682, 43431, 46357, 52170, 52642, 53409, 65092, 85919, 86014)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1443, 1701, 3001, 3357, 4254, 5513, 8128, 17488, 18747, 26912, 26962, 26976, 26999, 28698, 33617, 33640, 43431, 46357, 52170, 52642, 53409, 65092, 85919, 86014)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1443, 1701, 3001, 3357, 5513, 8128, 17488, 18747, 28698, 33617, 33640, 43431, 46357, 52170, 52642, 53409, 65092, 85919, 86014)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1443, 1701, 3001, 3357, 4254, 5513, 8128, 16663, 17488, 18747, 33617, 33640, 43431, 46357, 52170, 52642, 53409, 65092, 85919, 86014)
