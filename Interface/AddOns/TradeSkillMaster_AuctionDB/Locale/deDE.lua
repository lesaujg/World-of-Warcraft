...
L["GetAll scan did not run successfully due to issues on Blizzard's end. Using the TSM desktop application for your scans is recommended."] = "Der GetAll Scan konnte nicht vollständig abgeschlossen werden aufgrund von Problemen bei Blizzard. Der Einsatz der TSM Desktop Anwendung wird für deine Scans empfohlen." -- Needs review
