...
L["GetAll scan did not run successfully due to issues on Blizzard's end. Using the TSM desktop application for your scans is recommended."] = "快速扫描因为被暴雪终止而没有成功。推荐使用TSM桌面软件。"
