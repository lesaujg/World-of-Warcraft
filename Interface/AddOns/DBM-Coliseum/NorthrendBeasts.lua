...
local specWarnAnger3		= mod:NewSpecialWarningStack(66636, "Tank|Healer", 3)
...
local specWarnTranq			= mod:NewSpecialWarningDispel(66759, "RemoveEnrage")
...
local timerNextImpale		= mod:NewNextTimer(10, 66331, nil, "Tank|Healer")
