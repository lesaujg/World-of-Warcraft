...
L["Zurai"] = true
L["Zurii"] = true
L["ToC/Description"] = "Ackis Recipe List is an addon which will scan your trade skills and provide information on how to obtain recipes. It works for all tradeskills including Runeforging."
