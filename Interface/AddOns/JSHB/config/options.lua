...
function JSHB.Options:SetupOptions()
	...
	t.args.focusbar			= JSHB.Options:Panel_FocusBar(4)
	t.args.enrage			= JSHB.Options:Panel_Enrage(5)
	t.args.aspectindicator	= JSHB.Options:Panel_AspectIndicator(6)
	t.args.interrupts		= JSHB.Options:Panel_Interrupts(7)
	t.args.masterscall		= JSHB.Options:Panel_MastersCall(8)
	t.args.misdirection		= JSHB.Options:Panel_Misdirection(9)
	t.args.aspectofthefox	= JSHB.Options:Panel_AspectOfTheFox(10)
	t.args.snipertraining	= JSHB.Options:Panel_SniperTrainingIndicator(11)
