...
L["Current focus number"] = "현재 집중 수치"
L["Days"] = "일"
...
L["DESC_ENERGYBARFONTOFFSET"] = "시간 글씨의 위치를 기본 위치에서 왼쪽/오른쪽으로 조정할 수 있습니다."
...
L["ENERGYBARCOLORNORM_DESC"] = "이 색은 높은/낮은 임계치 설정이나 표시기 설정에 따라 무시될 수 있습니다."
L["Energy font"] = "집중 폰트"
L["Energy offset"] = "집중 오프셋"
L["Enrage Alert"] = "격노 경보"
L["Enrage Alert Removable Buffs"] = "격노 경보 해제 가능한 강화효과"
...
L["Focus"] = "주시 대상"
L["Focus Bar"] = "집중 바"
L["FOCUSBARACTIVEALPHA_DESC"] = "집중 바가 차거나 닳고 있을 때(활동 시)의 alpha 값입니다."
L["FOCUSBARAUTOSHOTBARDESC_ENABLE"] = "다음 자동 사격이 언제 일어날지를 집중 바 아래에서 움직이는 바로 표시합니다."
L["FOCUSBARDEADALPHA_DESC"] = "사망 시 특별 설정이 켜 있고 현재 사망했거나 유령이면 바의 alpha 값을 이 값으로 정합니다."
L["FOCUSBARHIGHWARNDESC_ENABLE"] = "미리 정한 기준보다 에너지가 높거나 에너지가 최대치를 넘어갈 것 같으면 바의 색을 바꿉니다."
L["FOCUSBARHIGHWARNTHRESHOLD_DESC"] = "집중이 이 %에 도달하면 고 에너지 경보 색을 씁니다."
L["FOCUSBARINACTIVEALPHA_DESC"] = "집중 바가 차거나 닳고 있지 않을 때(비활동 시)의 alpha 값입니다."
L["FOCUSBARLOWWARNDESC_ENABLE"] = "주 사격 기술을 쓰기에 집중이 부족하면 바의 색을 바꿉니다."
L["FOCUSBARNUMBERDESC_ENABLE"] = "바의 집중을 숫자로 표시합니다."
L["FOCUSBARSTACKSEMBEDDESC_ENABLE"] = [=[선택하면, 중첩 표시기를 집중 바의 오른쪽 위에 포함합니다.
해제하면 중첩 표시기를 바 밖으로 자유롭게 움직일 수 있습니다.]=]
L["FOCUSBARSTACKSIZE_DESC"] = "중첩을 집중 바 밖으로 뺐을 때 중첩 하나의 크기입니다."
L["FOCUSBARSTACKSREVERSEDESC_ENABLE"] = "중첩이 오른쪽에서 왼쪽으로 쌓입니다. (원래는 왼쪽에서 오른쪽으로 쌓입니다.)"
L["FOCUSBARTICKDESC_ENABLE"] = "이 눈금을 사용합니다. (눈금은 특정 주문을 시전하기 위해 에너지가 얼마나 필요한지를 보여줍니다.)"
L["Focus font"] = "집중 폰트"
L["Focus offset"] = "집중 오프셋"
...
L["Master's Call"] = "주인의 부름"
L["Match alpha of energy bar"] = "집중 바와 같은 alpha 값 사용"
L["Match alpha of focus bar"] = "집중 바와 같은 alpha 값 사용"
...
L["Sniper Training Indicator"] = "저격 훈련"
L["Solo"] = "솔플에서"
