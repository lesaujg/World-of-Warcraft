...
function JSHB:VARIABLES_LOADED()
	...
	do
		...
		JSHB.RegisterConfigFunction("MOD_FOCUSBAR", JSHB.SetupFocusBarModule)								-- Focus bar Module
		JSHB.RegisterConfigFunction("MOD_ENRAGE", JSHB.SetupEnrageModule)									-- Enrage Module	
		JSHB.RegisterConfigFunction("MOD_ASPECTINDICATOR", JSHB.SetupAspectIndicatorModule)					-- Aspect Indicator Module
		...
		JSHB.RegisterConfigFunction("MOD_ASPECTOFTHEFOXANNOUNCE", JSHB.SetupAspectOfTheFoxAnnounceModule)	-- Aspect of the Fox Announce Module
		JSHB.RegisterConfigFunction("MOD_SNIPERTRAININGINDICATOR", JSHB.SetupSniperTrainingIndicatorModule) -- Sniper Training Indicator Module
	end
