...
DBM = {
	Revision = parseCurseDate("20200206211109"),
	DisplayVersion = "8.3.11", -- the string that is shown as version
...
local fakeBWVersion, fakeBWHash = 178, "4a8bec2"
...
function bossModPrototype:SetRevision(revision)
	...
	if not revision or revision == "20200206211109" then
