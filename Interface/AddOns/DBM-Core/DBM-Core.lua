...
-------------------------------
DBM = {
	Revision = tonumber(("$Revision: 17229 $"):sub(12, -3)),
	DisplayVersion = "7.3.19", -- the string that is shown as version
	ReleaseRevision = 17229 -- the revision of the latest stable version that is available
}
