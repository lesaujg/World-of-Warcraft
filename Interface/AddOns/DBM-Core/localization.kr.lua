...
DBM_CORE_LOAD_MOD_SUCCESS			= "'%s' 모드를 불러왔습니다. 사용자 지정 경고 효과음을 설정하거나 개인적으로 메모를 적어놓고 싶다면 /dbm을 입력하세요."
DBM_CORE_LOAD_MOD_COMBAT			= "전투가 종료될 때까지 %s|1을;를; 불러오지 않습니다."
DBM_CORE_LOAD_GUI_ERROR				= "GUI를 불러오지 못함: %s"
DBM_CORE_LOAD_GUI_COMBAT			= "전투중에는 GUI의 최초 불러오기를 할 수 없습니다. 전투가 종료되면 GUI를 불러올 것입니다. GUI를 불러온 이후에는 전투중에 GUI를 열 수 있습니다."
DBM_CORE_BAD_LOAD					= "DBM이 전투로 인해 현재 인스턴스의 모드를 완전히 불러오지 못했습니다. 전투가 종료된 후 가능한 빨리 /console reloadui 명령어를 입력해주세요."
DBM_CORE_LOAD_MOD_VER_MISMATCH		= "DBM-Core가 요구 조건에 맞지 않아 %s|1을;를; 불러오지 못했습니다. 업데이트된 버전이 필요합니다"
...
DBM_CORE_UPDATE_REQUIRES_RELAUNCH		= "경고: 지금 업데이트한 DBM은 게임 클라이언트를 완전히 재시작하기 전까진 정상 작동하지 않습니다. 이 업데이트엔 새 파일이 포함되어 있거나 UI 재시작으로는 불러올 수 없는 .toc 파일의 변경 사항이 있습니다. 클라이언트 재시작 없이 사용할 경우 오류가 발생하거나 작동하지 않을 수 있습니다."
...
DBM_CORE_AUTO_ANNOUNCE_TEXTS.adds			= "%s 남음: %%d"
...
DBM_CORE_AUTO_ANNOUNCE_TEXTS.phase			= "%s단계"
DBM_CORE_AUTO_ANNOUNCE_TEXTS.prephase		= "곧 %s단계"
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.phase		= "%s단계 알림"
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.phasechange	= "단계 전환 알림"
DBM_CORE_AUTO_ANNOUNCE_OPTIONS.prephase		= "%s단계로 넘어가기 전 경고 보기"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.move			= "$spell:%s 바닥 피하기 특수 경고 보기"
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS.moveto			= "$spell:%s 대상으로 이동 특수 경고 보기"
