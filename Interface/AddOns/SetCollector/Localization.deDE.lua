...
local L = LibStub("AceLocale-3.0"):NewLocale("SetCollector", "deDE")
if not L then return end

L["ADDON_NAME"] = "Set Collector"
L["ALLIANCE"] = "Allianz"
L["ASPIRANT"] = "Aspirant"
L["BINDING_TOGGLE_UI"] = "Set Collector-Fenster an/aus"
L["BLACK"] = "Schwarz"
L["BLUE"] = "Blau"
L["BROWN"] = "Braun"
--Translation missing 
L["CAPTAIN"] = "Captain's Hat"
L["CHAR_DB_UPGRADED"] = "Set Collector: Charakterdatenbank verbessert."
L["CLOTH"] = "Stoff"
L["COMBATANT"] = "Kämpfer"
--Translation missing 
L["CRAFTED"] = "Crafted"
--Translation missing 
L["CUSTOM"] = "Custom"
L["DB_UPGRADED"] = "Set Collector: Datenbank verbessert."
--Translation missing 
L["DEBUG_OFF"] = "Debug Off."
--Translation missing 
L["DEBUG_ON"] = "Debug On."
L["DG_CLOTH_03"] = "Managetränktes Ornat"
L["DG_LEATHER_03"] = "Ödniswandlerrüstung"
L["DG_MAIL_03"] = "Schlachtrüstung der Verwüstung"
L["DG_PLATE_03"] = "Verdammnisplattenrüstung"
--Translation missing 
...
L["GA_ALLIANCE_SET"] = "Sturmwindset"
L["GA_BWM_SET_100"] = "Zwergenbunkers/Kriegswerkstatt-Sets"
L["GA_HORDE_SET"] = "Orgrimmarset"
L["GARRISON"] = "Garnison"
L["GLADIATOR"] = "Gladiator"
L["GREEN"] = "Grün"
L["HIDE_DETAIL"] = "Einzelheiten verstecken"
--Translation missing 
...
L["L90"] = "90"
L["LEATHER"] = "Leder"
L["LG_60"] = "Sulfuras, Hand von Ragnaros"
L["LG_80"] = "Schattengram"
--Translation missing 
...
L["OBTAIN_FILTER"] = "Nur erhältlich"
L["ORIGINAL"] = "Original"
L["OT_ELR_100"] = "Ornat des Eredarlords"
--Translation missing 
...
L["RAID"] = "Schlachtzug"
L["RED"] = "Rot"
L["REPLICA"] = "Nachbildung"
L["RIGHT_CLICK_FAVORITE"] = "Rechtsklick, um ein Set als Favorit zu setzen. Die Liste kann gefiltert werden, um nur deine Lieblingssets anzuzeigen."
--Translation missing 
...
L["SLASH_HELP"] = [=[Set Collector: Die verfügbaren Befehle sind: "show", "hide", "sort",, "button" "resetdb" oder "help".
Zum Beispiel: "/setcollector show"]=]
L["SLASH_HELP_BUTTON"] = [=[Set Collector: Dieser Befehl zeigt an (button show) oder versteckt (button hide) die Minikartenschaltfläche. Er schaltet die Sichbarkeit um, wenn keinen zweiten Befehl eingegeben wird.
Zum Beispiel: "/setcollector button hide" oder "/setcollector button"]=]
L["SLASH_HELP_SORT"] = [=[Set Collector: Dieser Befehl legt die Sortierrichtung fest. Gebt "asc" für aufsteigenden Sortierung, oder "desc" für absteigende ein.
...
L["TUTORIAL_3"] = "Wenn es mehrere Varianten eines Sets gibt, wird Reiter für jede Variante angezeigt."
L["TUTORIAL_4"] = "Eine Setsvorschau wird hier angezeigt werden. Klicken auf ein Set auf der linken Seite, um eine Vorschau hier zu sehen."
L["VENDOR"] = "Verkäufersset"
L["VOID_STORAGE_NOT_READY"] = "Set Collector: Das Leerenlager ist nicht scanbar. Bitte es schließen und wiedereröffnen."
--Translation missing 
