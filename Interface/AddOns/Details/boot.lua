...
--> global name declaration
		...
		_detalhes.build_counter = 3673
		_detalhes.userversion = "v7.2.0." .. _detalhes.build_counter
		_detalhes.realversion = 118 --core version
