...
-- WeakAuras/Options
	...
	L["%i Matches"] = "%i 個符合"
	L["%s - Option #%i has the key %s. Please choose a different option key."] = "%s - 選項 #%i 已經有 key %s。請選擇其他選項 key。"
	L["%s %s, Lines: %d, Frequency: %0.2f, Length: %d, Thickness: %d"] = "%s %s, 線條: %d, 頻率: %0.2f, 長度: %d, 粗細: %d"
	L["%s %s, Particles: %d, Frequency: %0.2f, Scale: %0.2f"] = "%s %s, 粒子: %d, 頻率: %0.2f, 縮放大小: %0.2f"
	L["%s Alpha: %d%%"] = "%s 透明度: %d%%"
	L["%s Color"] = "%s 顏色"
	L["%s Default Alpha, Zoom, Icon Inset, Aspect Ratio"] = "%s 預設透明度, 縮放, 圖示內縮, 長寬比例"
	L["%s Inset: %d%%"] = "%s 內縮: %d%%"
	L["%s is not a valid SubEvent for COMBAT_LOG_EVENT_UNFILTERED"] = "%s 不是 COMBAT_LOG_EVENT_UNFILTERED 有效的 SubEvent"
	L["%s Keep Aspect Ratio"] = "%s 保持長寬比例"
	...
	L["|cFFffcc00Anchors:|r Anchored |cFFFF0000%s|r to frame's |cFFFF0000%s|r"] = "|cFFffcc00對齊:|r |cFFFF0000%s|r 已對齊到框架的|cFFFF0000%s|r"
	L["|cFFffcc00Anchors:|r Anchored |cFFFF0000%s|r to frame's |cFFFF0000%s|r with offset |cFFFF0000%s/%s|r"] = "|cFFffcc00對齊:|r |cFFFF0000%s|r 已對齊到框架的|cFFFF0000%s|r，位置偏移 |cFFFF0000%s/%s|r"
	L["|cFFffcc00Anchors:|r Anchored to frame's |cFFFF0000%s|r"] = "|cFFffcc00對齊:|r 已對齊到框架的|cFFFF0000%s|r"
	L["|cFFffcc00Anchors:|r Anchored to frame's |cFFFF0000%s|r with offset |cFFFF0000%s/%s|r"] = "|cFFffcc00對齊:|r 已對齊到框架的|cFFFF0000%s|r，位置偏移 |cFFFF0000%s/%s|r"
	L["|cFFffcc00Extra Options:|r"] = "|cFFffcc00額外選項:|r"
	L["|cFFffcc00Font Flags:|r |cFFFF0000%s|r and shadow |c%sColor|r with offset |cFFFF0000%s/%s|r %s"] = "|cFFffcc00文字樣式:|r |cFFFF0000%s|r和陰影|c%s顏色|r，位置偏移 |cFFFF0000%s/%s|r %s"
	L["|cFFffcc00Font:|r %s %s"] = "|cFFffcc00字體:|r %s %s"
	L["1 Match"] = "1 個符合"
...
是否要將這個顯示效果放到一個新的 |cFF22AA22動態群組|r 裡面?]=]
	...
	L["Condition %i"] = "條件 %i"
	L["Conditions"] = "條件"
	L["Configure what options appear on this pannel."] = "設定這個面板中要出現哪些選項。"
...
UNIT_POWER, UNIT_AURA PLAYER_TARGET_CHANGED]=]
	...
	L["Determines how many entries can be in the table."] = "決定表格中能夠有多少個項目。"
	L["Differences"] = "差異"
